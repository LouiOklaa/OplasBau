            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    ...
                    <p data-aos="fade-up">Ihrem Experten für hochwertige Bauleistungen!
                        Unsere Firma bietet Ihnen professionelle Dienstleistungen im Bereich Trockenbau, Parkett,
                ...
                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up">
                    <div class="content">
                        ...
                        <p>Jedes Bauprojekt beginnt mit einer Vision – und wir sind hier, um sie Wirklichkeit werden zu
                            lassen. Ob es sich um Trockenbau, Parkett, Laminat, Fliesen, Gipskarton oder Malerarbeiten
                ...
                <div class="tab-pane active show" id="tab-1">
                    <div class="row">
                        <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center"
                            ...
                            <p class="fst-italic">
                                Wir bei OPLAS BAU gewährleisten die Umsetzung von Projekten nach den höchsten
                                Qualitätsstandards.
                            </p>
                            <ul>
                                ...
                                <li><i class="bi bi-check2-all"></i> Wir verwenden hochwertige Baustoffe, um Haltbarkeit
                                    zu gewährleisten.
                                </li>
    ...
    <section id="recent-blog-posts" class="recent-blog-posts">
        <div class="container" data-aos="fade-up">
            <div class=" section-header">
                ...
                <p>Wir bei OPLAS BAU bieten eine breite Palette von Dienstleistungen im Bauwesen an, die speziell auf
                        ...
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    ...
                                    OPLAS BAU hat unsere Wände perfekt gestrichen. Die Farben sind genau so, wie wir sie
                                    uns vorgestellt haben, und die Arbeit wurde extrem sauber ausgeführt. Das Team war
                                    pünktlich und sehr professionell. Absolut empfehlenswert!
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    Wir haben unsere Küche und das Badezimmer von OPLAS BAU fliesen lassen, und das
                                    Ergebnis ist einfach fantastisch! Die Fliesen sind makellos verlegt, und die Muster
                                    passen perfekt. Auch die Absprachen liefen reibungslos. Sehr zufrieden!
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    Das Parkett in unserem Wohnzimmer sieht jetzt dank OPLAS BAU wunderschön aus. Sie
                                    haben hochwertige Materialien verwendet und haben die Arbeit pünktlich
                                    abgeschlossen. Jeder Schritt wurde mit Präzision ausgeführt. Sehr beeindruckt!
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    Die Trockenbauarbeiten wurden schnell und ohne Komplikationen erledigt. Die Wände
                                    sehen sehr stabil und glatt aus. Das Team von OPLAS BAU hat alles termingerecht
                                    fertiggestellt und war jederzeit hilfsbereit und freundlich.
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    Ich bin sehr zufrieden mit der Gipskarton-Arbeit von OPLAS BAU. Die Installation war
                                    präzise und das Endergebnis hat die Raumaufteilung viel besser gemacht. Ein
                                    professioneller und zuverlässiger Service.
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
