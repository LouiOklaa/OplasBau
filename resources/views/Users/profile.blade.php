                            ...
                            <div class="card-body">
                                ...
                                <div class="main-profile-overview">
                                    <div class="main-img-user profile-user">
                                        <img alt="Profile Picture" src="{{ URL::asset('assets/images/faces/face.jpg') }}" class="profile-picture">
                                    </div><br>
                                    <div class="profile-info">
                                        <h5 class="main-profile-name">{{$user->name}}<span class="main-profile-role"> - {{$user->role_name}}</span></h5>
                                        ...
                                        <div class="main-profile-social-list">
                                            <div class="media">
                                                <div class="media-icon">
                                                    <a  href="https://github.com/LouiOklaa" class="mdi mdi-github-circle icon-color"></a>
                                                    <a href="https://www.facebook.com/loui.oklaa/" class="mdi mdi-facebook icon-color"></a>
                                                    <a href="https://www.linkedin.com/in/loui-oklaa/" class="mdi mdi-linkedin icon-color"></a>
                                                    <a href="https://www.instagram.com/loui_oklaa/" class="mdi mdi-instagram icon-color"></a>
                                                    <a href="https://wa.me/+4917670352663" class="mdi mdi-whatsapp icon-color"></a>
                                                    <a href="https://x.com/loui_oklaa">
                                                        <svg style="margin-bottom: 11px" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-twitter-x icon-color" viewBox="0 0 16 16">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <div class="icon icon-box-info ">
                                                    <span class="mdi mdi-library-books icon-item"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <div class="icon icon-box-success ">
                                                    <span class="mdi mdi-collage icon-item"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <div class="icon icon-box-danger ">
                                                    <span class="mdi mdi-format-list-bulleted-type icon-item"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-9">
                                                <h5 class="text-left text-size">Insgesamt Aktivitäten</h5>
                                                <h4 class="text-muted font-weight-normal text-left">{{number_format($projectsCount + $servicesSectionsCount + $servicesCount)}}</h4>
                                            </div>
                                            <div class="col-3">
