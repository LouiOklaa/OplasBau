            ...
            <div class="col-lg-7 mx-auto text-white">
              <div class="row align-items-center d-flex flex-row">
                ...
                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                  ...
                  <h3 class="font-weight-light">Der Benutzer verfügt nicht über die richtigen Berechtigungen!</h3>
                </div>
              </div>
              <div class="row mt-5">
                <div class="col-12 text-center mt-xl-2">
                  <a class="text-white font-weight-medium" href="{{ url('/' . $page='admin') }}">Zurück zum Dashboard</a>
                </div>
              </div>
              <div class="row mt-5">
