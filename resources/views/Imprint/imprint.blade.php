...
@section('contents')
    ...
    <div class="container">
        <p><span style="font-weight: bolder; font-size: 25px">OPLAS BAU</span><br>{{$information->address}}<br>Telefon
            : {{$information->phone_number}}<br>E-Mail : <a
                href="{{route('contact_us')}}">{{$information->email}}</a><br>Internet : <a href="{{url('/')}}">www.oplas-bau.de</a>
        </p><br><br>
        ...
        <p>Die OPLAS BAU bemüht sich, dass die auf dieser Website enthaltenen Informationen und Daten zutreffend sind.
        ...
        <p>Die OPLAS BAU behält sich vor, ohne Ankündigung Änderungen oder Ergänzungen der bereitgestellten
        ...
        <p>Soweit unsere Internetseiten in die Zukunft gerichtete Aussagen enthalten, bauen diese Aussagen auf
            Überzeugungen und Einschätzungen der OPLAS BAU auf und unterliegen damit Risiken und Unsicherheiten. Eine
            Haftung für solche Aussagen wird ausdrücklich ausgeschlossen.</p>

        <p><strong>Links und Verweise (Haftungsausschluss)</strong></p>
        <p>Von den eigenen Inhalten der OPLAS BAU sind Querverweise ("Links") auf die Webseiten anderer Anbieter
            gesetzt, durch welche lediglich Zugang zu fremden Inhalten eröffnet wird. Für diese fremden Inhalte ist die
            OPLAS BAU nicht verantwortlich.</p>

        <p><strong>Urheberrecht</strong></p>
        <p>Falls nicht anders angegeben, sind Inhalt und Struktur der Webseiten der OPLAS BAU urheberrechtlich
