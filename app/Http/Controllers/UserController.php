...
class UserController extends Controller
{
    ...
    public function profile ($id){
        ...
        $servicesCount = Services::where('created_by' , '=' , $id)->count();
        $projectsCount = Gallery::where('created_by' , '=' , $id)->count();
        $servicesSectionsCount = ServicesSections::where('created_by' , '=' , $id)->count();

        return view('Users.profile',compact('role' , 'user' , 'servicesCount' , 'projectsCount' , 'servicesSectionsCount'));
